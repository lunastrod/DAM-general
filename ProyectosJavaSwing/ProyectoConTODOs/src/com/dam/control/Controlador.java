...
public class Controlador implements ActionListener {
	...
	public Controlador(VPRestaurantes vp) {
		this.vp = vp;
		// TODO: instanciar datosRestaurantes = new RestaurantesDAO()
	}
	...
	public void actionPerformed(ActionEvent ev) {
		...
		if (ev.getSource() instanceof JMenuItem) {
			...
			if (ev.getSource().equals(vp.getMntmConsulta())) {
				// TODO: cargar el combo de regiones del panel de consulta llamando a
				//       pcr.cargarCombo() y pasándole datosRestaurantes.selectRegiones()
				// TODO: limpiar el panel de consulta con pcr.limpiarConsulta()
				// TODO: cargar el panel de consulta en la ventana principal con vp.cargarPanel(pcr)

			} else if (ev.getSource().equals(vp.getMntmAlta())) {
				// TODO: cargar el panel de registro con vp.cargarPanel(prr)

			} else if (ev.getSource().equals(vp.getMntmSalir())) {
				// TODO: llamar a vp.confirmarSalida()

			} else {
				// TODO: cargar el panel de modificación con vp.cargarPanel(pmr)
			}
	...
	private void consultarRestaurantes() {
		// TODO: recuperar la región seleccionada del combo con pcr.getCmbRegion().getSelectedItem()
		//       hacer cast a String
